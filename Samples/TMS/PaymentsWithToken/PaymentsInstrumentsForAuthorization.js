...
function paymentInstrumentsForAuthorization() {
    try {
...
if (require.main === module) {
    paymentInstrumentsForAuthorization();
}
module.exports.paymentInstrumentsForAuthorization = paymentInstrumentsForAuthorization;