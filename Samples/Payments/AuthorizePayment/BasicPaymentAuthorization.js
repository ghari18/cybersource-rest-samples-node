 ...
 */
function processBasicPaymentAuthorization() {
...
if (require.main === module) {
    processBasicPaymentAuthorization(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processBasicPaymentAuthorization = processBasicPaymentAuthorization;