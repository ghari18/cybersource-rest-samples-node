 ...
 */
function processVoiceAuthReferral() {
    try {
        ...
        authorizationOptions = new CybersourceRestApi.V2paymentsProcessingInformationAuthorizationOptions();
...
if (require.main === module) {
    processVoiceAuthReferral(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processVoiceAuthReferral = processVoiceAuthReferral;