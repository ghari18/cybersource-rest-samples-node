 ...
 * createPayment method will create a new payment with Visa purchase card level 2
 */
function processPurchaseCardLevel2Visa() {
    try {
...
if (require.main === module) {
    processPurchaseCardLevel2Visa(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPurchaseCardLevel2Visa = processPurchaseCardLevel2Visa;