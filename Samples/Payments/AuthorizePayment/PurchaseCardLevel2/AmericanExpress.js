 ...
 * createPayment method will create a new payment with American Express purchase card level 2
 */
function processPurchaseCardLevel2AmericanExpress() {
    try {
        var apiClient = new CybersourceRestApi.ApiClient();
        var instance = new CybersourceRestApi.PaymentApi(apiClient);

        var clientReferenceInformation = new CybersourceRestApi.V2paymentsClientReferenceInformation();
        clientReferenceInformation.code = "TC50171_13";
        ...
        invoiceDetails.transactionAdviceAddendum = [{
...
if (require.main === module) {
    processPurchaseCardLevel2AmericanExpress(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPurchaseCardLevel2AmericanExpress = processPurchaseCardLevel2AmericanExpress;