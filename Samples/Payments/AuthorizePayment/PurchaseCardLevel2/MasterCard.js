 ...
 * createPayment method will create a new payment with Master purchase card level 2
 */
function processPurchaseCardLevel2MasterCard() {
    try {
...
if (require.main === module) {
    processPurchaseCardLevel2MasterCard(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPurchaseCardLevel2MasterCard = processPurchaseCardLevel2MasterCard;