 ...
 */
function processDollarZeroAuthorization() {
...
if (require.main === module) {
    processDollarZeroAuthorization(function () {
        console.log('Method call complete.');
    });
}
module.exports.processDollarZeroAuthorization = processDollarZeroAuthorization;