 ...
 * createPayment method will create a new payment with purchaseLevel 2.
 */
function processLevel2Data() {
...
if (require.main === module) {
    processLevel2Data(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processLevel2Data = processLevel2Data;