 ...
 */
function processVerbalAuthorizationCapture() {
...
if (require.main === module) {
    processVerbalAuthorizationCapture(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processVerbalAuthorizationCapture = processVerbalAuthorizationCapture;