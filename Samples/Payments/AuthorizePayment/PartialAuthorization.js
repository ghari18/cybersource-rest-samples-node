 ...
 */
function processPartialAuthorization() {
...
if (require.main === module) {
    processPartialAuthorization(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPartialAuthorization = processPartialAuthorization;