 ...
 */
function processAmericanExpressSafeKey() {
...
if (require.main === module) {
    processAmericanExpressSafeKey(function () {
        console.log('Method call complete.');
    });
}
module.exports.processAmericanExpressSafeKey = processAmericanExpressSafeKey;