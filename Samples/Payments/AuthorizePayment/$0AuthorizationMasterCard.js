 ...
 */
function processDollarZeroAuthorizationMasterCard() {
...
if (require.main === module) {
    processDollarZeroAuthorizationMasterCard(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processDollarZeroAuthorizationMasterCard = processDollarZeroAuthorizationMasterCard;