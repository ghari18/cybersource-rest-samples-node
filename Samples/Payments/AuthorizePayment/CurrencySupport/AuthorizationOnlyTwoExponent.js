 ...
 * for currency supported two exponents 
 * createPayment method will create a new payment
 */
function processAuthorizationTwoExponent() {
    try {
...
if (require.main === module) {
    processAuthorizationTwoExponent(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizationTwoExponent = processAuthorizationTwoExponent;