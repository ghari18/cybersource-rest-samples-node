 ...
 * for currency supported zero exponents 
 * createPayment method will create a new payment
 */
function processAuthorizationZeroExponent() {
    try {
...
if (require.main === module) {
    processAuthorizationZeroExponent(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizationZeroExponent = processAuthorizationZeroExponent;