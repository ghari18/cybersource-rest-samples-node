 ...
 * createPayment method will create a new payment with Visa purchase card level 3
 */
function processPurchaseCardLevel3VisaCopy() {
    try {
...
if (require.main === module) {
    processPurchaseCardLevel3VisaCopy(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPurchaseCardLevel3VisaCopy = processPurchaseCardLevel3VisaCopy;