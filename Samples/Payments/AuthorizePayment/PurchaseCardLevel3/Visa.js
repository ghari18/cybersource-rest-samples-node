 ...
 */
function processPurchaseCardLevel3Visa() {
    try {
...
if (require.main === module) {
    processPurchaseCardLevel3Visa(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processPurchaseCardLevel3Visa = processPurchaseCardLevel3Visa;