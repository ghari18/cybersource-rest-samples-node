 ...
 */
function processAuthorizationOnlyRetail() {
    try {
...
if (require.main === module) {
    processAuthorizationOnlyRetail(function () {
        console.log('Method call complete.');
    });
}
module.exports.processAuthorizationOnlyRetail = processAuthorizationOnlyRetail;