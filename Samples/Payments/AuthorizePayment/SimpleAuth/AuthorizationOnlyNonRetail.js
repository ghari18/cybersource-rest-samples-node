 ...
 */
function processAuthorizationOnlyNonRetail() {
    try {
...
if (require.main === module) {
    processAuthorizationOnlyNonRetail(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizationOnlyNonRetail = processAuthorizationOnlyNonRetail;