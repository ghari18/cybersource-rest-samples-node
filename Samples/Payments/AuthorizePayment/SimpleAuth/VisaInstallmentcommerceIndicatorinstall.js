 ...
 */
function processVisaInstallmentcommerceIndicatorinstall() {
    try {
        ...
        clientReferenceInformation.code = "TC50171_9";
...
if (require.main === module) {
    processVisaInstallmentcommerceIndicatorinstall(function () {
        console.log('Method call complete.');
    });
}
module.exports.processVisaInstallmentcommerceIndicatorinstall = processVisaInstallmentcommerceIndicatorinstall;