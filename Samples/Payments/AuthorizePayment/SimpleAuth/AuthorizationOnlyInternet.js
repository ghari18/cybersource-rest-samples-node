 ...
 */
function processAuthorizationOnlyInternet() {
    try {
...
if (require.main === module) {
    processAuthorizationOnlyInternet(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizationOnlyInternet = processAuthorizationOnlyInternet;