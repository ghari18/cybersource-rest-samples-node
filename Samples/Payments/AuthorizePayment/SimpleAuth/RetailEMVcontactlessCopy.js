 ...
 */
function processRetailEVMContactlessCopy() {
    try {
...
if (require.main === module) {
    processRetailEVMContactlessCopy(function () {
        console.log('Method call complete.');
    });
}
module.exports.processRetailEVMContactlessCopy = processRetailEVMContactlessCopy;