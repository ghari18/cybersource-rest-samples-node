...
/**
 * This is a sample code to run PaymentAPI createPayment with Master card CVC2
 */

function processMasterCardCVC2() {
    try {
        ...
        amountDetails.totalAmount = "160.00";
...
if (require.main === module) {
    processMasterCardCVC2(function () {
        console.log('Method call complete.');
    });
}
module.exports.processMasterCardCVC2 = processMasterCardCVC2;