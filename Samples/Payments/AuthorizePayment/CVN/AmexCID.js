...
/**
 * This is a sample code to run PaymentAPI createPayment with Amex card CID.
 */
function processAmexCID() {
    try {
...
if (require.main === module) {
    processAmexCID(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAmexCID = processAmexCID;