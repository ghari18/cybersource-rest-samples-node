...
/**
 * This is a sample code to run PaymentAPI createPayment with Discover card CID.
 */
function processDiscoverCID() {
    try {
...
if (require.main === module) {
    processDiscoverCID(function () {
        console.log('Method call complete.');
    });
}
module.exports.processDiscoverCID = processDiscoverCID;