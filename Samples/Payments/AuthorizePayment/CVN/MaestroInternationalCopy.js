...
function processMaestroInternationalCopy() {
    try {
...
if (require.main === module) {
    processMaestroInternationalCopy(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processMaestroInternationalCopy = processMaestroInternationalCopy;