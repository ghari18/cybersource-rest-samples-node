 ...
 * createPayment method will create a new payment with purchaseLevel 3.
 */
function processLevel3Data() {
...
if (require.main === module) {
    processLevel3Data(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processLevel3Data = processLevel3Data;