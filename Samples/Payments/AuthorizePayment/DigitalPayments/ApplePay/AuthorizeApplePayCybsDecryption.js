 ...
 */
function processAuthorizeApplePayCybsDecryption() {
...
if (require.main === module) {
    processAuthorizeApplePayCybsDecryption(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizeApplePayCybsDecryption = processAuthorizeApplePayCybsDecryption;