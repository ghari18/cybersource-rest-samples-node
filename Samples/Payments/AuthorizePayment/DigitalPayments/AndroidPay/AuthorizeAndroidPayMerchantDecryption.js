 ...
 */
function processAuthorizeAndroidPayMerchantDecryption() {
...
if (require.main === module) {
    processAuthorizeAndroidPayMerchantDecryption(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizeAndroidPayMerchantDecryption = processAuthorizeAndroidPayMerchantDecryption;