 ...
 */
function processSamsungRetailEVMContactless() {
...
if (require.main === module) {
    processSamsungRetailEVMContactless(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processSamsungRetailEVMContactless = processSamsungRetailEVMContactless;