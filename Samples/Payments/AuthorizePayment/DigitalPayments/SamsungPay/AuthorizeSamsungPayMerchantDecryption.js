 ...
 */
function processAuthorizeSamsungPayMerchantDecryption() {
...
if (require.main === module) {
    processAuthorizeSamsungPayMerchantDecryption(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processAuthorizeSamsungPayMerchantDecryption = processAuthorizeSamsungPayMerchantDecryption;