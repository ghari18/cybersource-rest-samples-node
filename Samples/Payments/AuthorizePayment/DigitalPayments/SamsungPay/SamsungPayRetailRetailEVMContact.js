 ...
 */
function processSamsungPayRetailEVMContact() {
...
if (require.main === module) {
    processSamsungPayRetailEVMContact(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processSamsungPayRetailEVMContact = processSamsungPayRetailEVMContact;