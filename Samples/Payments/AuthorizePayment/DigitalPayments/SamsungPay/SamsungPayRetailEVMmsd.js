 ...
 */
function processSamsungPayRetailEVMmsd() {
...
if (require.main === module) {
    processSamsungPayRetailEVMmsd(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processSamsungPayRetailEVMmsd = processSamsungPayRetailEVMmsd;