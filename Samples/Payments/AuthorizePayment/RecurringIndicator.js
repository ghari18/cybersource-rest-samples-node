 ...
 * createPayment method will create a new payment with commerceIndicator as recurring
 */
function processRecurringIndicator() {
...
if (require.main === module) {
    processRecurringIndicator(function () {
        console.log('getMethod call complete.');
    });
}
module.exports.processRecurringIndicator = processRecurringIndicator;